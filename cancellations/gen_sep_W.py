...
def separate(W,iterations,optimizer=optax.rmsprop(.01),smoothingperiod=25):
...
def learn(truth,ansatz,batchsize,maxbatchnumber,randkey,X_distribution,optimizer=optax.rmsprop(.01),smoothingperiod=25,printout=True):
