...
class Train:
	...
	def print_params(params,paramsfolder,descriptions,Ansatztype):
	...
	def get_params(ID,randkey,args):
		...
		print_params(params,paramsfolder,descriptions,Ansatztype)
